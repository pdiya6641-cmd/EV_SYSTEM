    ...
    <div class="row">
        ...
        <%
                    ...
                    <div class="col-md-4">
                        ...
                        <figure>
                        <a href="r_accessories.jsp?accessory_id=<%=rs1.getInt(1)%>">
                        ...
                        <p class="" ><span style="font-weight:bold">Price: </span><%= rs1.getString("accessory_price") %></p>
                            ...
                            <p class="" style="color:gray"><span style="font-weight:bold">Warranty Period:</span> <%= rs1.getString("accessory_warranty_period") %> years</p>
                             ...
                             <form action="addtocart.jsp" method="post">
                                <input type="number" name="order_quantity" placeholder="Quantity" style="border-radius:25px; border: 2px solid  grey; width: 150px; height:35px;">
                                <input type="hidden" name="accessory_id" value="<%=rs1.getInt(1)%>">
                                <input type="hidden" name="acc_price" value="<%=rs1.getString(5) %>">
                                <input type="hidden" name="user_id" value="<%=user_id%>">
                       <button type="submit" class="btn btn-outline-warning "  style="margin:10px; border-radius:25px;  ">Add to Cart</button><br>
                       </form>
                            </center>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form action="acc_feedback_add_code.jsp" method="post">
                        <input type="hidden" name="user_id" value="<%=user_id%>">
                        <input type="hidden" name="accessory_id" value="<%=accessory_id%>">
                        
                        <textarea name="acc_feedback_message" cols="110" rows="2" placeholder="Type your feedback here..." style=" border: 2px solid  grey;border-radius:20px; transition:box-shadow 0.3s ease; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"></textarea>

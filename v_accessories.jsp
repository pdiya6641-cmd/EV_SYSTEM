               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <div class="hover01 column">
                        <figure>
                            <a href="v_accessories.jsp?cat_id=<%=rs1.getInt(1)%>">
                      ...
                      <h3 class="read_bt_2" style="padding-left: 80px;"><a href="v_acc_details.jsp?accessory_id=<%=rs1.getInt(1)%>">EXPLORE MORE</a></h3>
                     </div>
                  </div>
                  <%
                     }

...
<%
    ...
    pstmt1 = conn.prepareStatement("INSERT INTO vehicle_order_master (vehicle_id, user_id, v_order_quantity, v_order_price_per_unit,v_order_total_price,v_order_status,v_order_date, v_delivery_date) SELECT vehicle_id, user_id, v_order_qty, v_order_price_per_unit, v_total_price, ?, ?, ? FROM vehicle_cart_master WHERE user_id = ?");
    ...
    pstmt2 = conn.prepareStatement("DELETE FROM vehicle_cart_master WHERE user_id = ?");
